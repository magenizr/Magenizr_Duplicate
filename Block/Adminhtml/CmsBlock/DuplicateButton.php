...
namespace Magenizr\Duplicate\Block\Adminhtml\CmsBlock;

use Magenizr\Duplicate\Helper\Data;
        ...
        if ($isEnabled && !empty($id)) {
            ...
            return [
                ...
                'on_click' => 'deleteConfirm(\'' . __(
                    'Are you sure you want to duplicate this CMS block?'
                ) . '\', \'' . $this->urlBuilder->getUrl(
                    'magenizr_duplicate/cmsBlock/duplicate',
                    ['id' => $id]
                ) . '\', {data: {}})',
                'sort_order' => 90
            ];
